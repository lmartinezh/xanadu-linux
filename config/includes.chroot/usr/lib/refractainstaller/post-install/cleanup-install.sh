...
sed -i 's/autologin-user=user/#autologin-user=user/g' /target/etc/lightdm/lightdm.conf
sed -i 's/autologin-user-timeout=0/#autologin-user-timeout=0/g' /target/etc/lightdm/lightdm.conf
